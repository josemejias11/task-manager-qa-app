...
Locator: locator('#form-warning')
Expected string: "Task title must be 20 characters or less"
Received string: "Task title must be 20 characters or less."
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for locator('#form-warning')
    9 × locator resolved to <div id="form-warning" class="text-danger mt-2">Task title must be 20 characters or less.</div>
      - unexpected value "Task title must be 20 characters or less."

    at /Users/josemejias/WebstormProjects/task-manager-qa-app/playwright/tests/task.spec.js:57:27
```
...
- textbox "New task...": AAAAAAAAAAAAAAAAAAAAA
- button "Add Task"
- button "Remove All"
- text: Task title must be 20 characters or less.
- list:
  - listitem:
    - text: Second Task
