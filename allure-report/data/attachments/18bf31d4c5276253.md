...
- Location: /tests/playwright/tests/task.spec.js:14:3
...
Call log:
  - waiting for locator('#task-list .btn-danger').nth(1)
    - locator resolved to <button aria-label="Delete task Check UUID" class="btn btn-sm btn-danger btn-delete-task" data-id="00e46860-edce-495f-a6b4-d4014d57ee8d">x</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
  - element was detached from the DOM, retrying

    at /tests/playwright/tests/task.spec.js:10:34
```
