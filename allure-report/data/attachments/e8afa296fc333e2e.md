...
- Location: /tests/playwright/tests/task.spec.js:43:3
...
Call log:
  - waiting for locator('#task-list .btn-danger').nth(1)
    - locator resolved to <button aria-label="Delete task Second Task" class="btn btn-sm btn-danger btn-delete-task" data-id="f72924dd-d7c3-4a80-b6cc-757e076716ac">x</button>
