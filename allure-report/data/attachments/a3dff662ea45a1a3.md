...
Call log:
  - waiting for locator('#task-list .btn-danger').nth(1)
    - locator resolved to <button aria-label="Delete task Check UUID" class="btn btn-sm btn-danger btn-delete-task" data-id="67911191-ae8d-4d08-a364-98ef8772d5a5">x</button>
