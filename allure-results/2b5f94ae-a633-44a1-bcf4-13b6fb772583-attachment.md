...
Call log:
  - waiting for locator('#task-list .btn-danger').nth(6)
    - locator resolved to <button aria-label="Delete task Check UUID" class="btn btn-sm btn-danger btn-delete-task" data-id="51acfaf8-774c-4438-8bbd-2b172d422ce7">x</button>
