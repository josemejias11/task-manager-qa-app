...
Call log:
  - waiting for locator('#task-list .btn-danger').nth(1)
    - locator resolved to <button aria-label="Delete task Check UUID" class="btn btn-sm btn-danger btn-delete-task" data-id="e2a69019-2f49-4cbc-9feb-8a7fd51c37da">x</button>
