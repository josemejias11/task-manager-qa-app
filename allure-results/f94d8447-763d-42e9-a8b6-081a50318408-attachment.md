...
- Location: /tests/playwright/tests/task.spec.js:57:3
...
Call log:
  - waiting for locator('#task-list .btn-danger').nth(6)
    - locator resolved to <button aria-label="Delete task Second Task" class="btn btn-sm btn-danger btn-delete-task" data-id="070da758-4b7e-4ee2-b323-93d4ee62c216">x</button>
