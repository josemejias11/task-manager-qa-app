...
- Location: /Users/josemejias/WebstormProjects/task-manager-qa-app/playwright/tests/task.spec.js:63:3
...
Call log:
  - waiting for locator('#task-list') to be visible
    12 × locator resolved to hidden <ul id="task-list" class="list-group mt-3"></ul>

    at /Users/josemejias/WebstormProjects/task-manager-qa-app/playwright/tests/task.spec.js:6:38
```
